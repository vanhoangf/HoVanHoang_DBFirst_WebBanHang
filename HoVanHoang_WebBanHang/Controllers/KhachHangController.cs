...
namespace HoVanHoang_WebBanHang.Controllers
{
    public class KhachHangController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,HoTen,SoDienThoai,Email,DiaChi")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,HoTen,SoDienThoai,Email,DiaChi")] KhachHang khachHang)
        {
            if (id != khachHang.Id)
            {
                return NotFound();
